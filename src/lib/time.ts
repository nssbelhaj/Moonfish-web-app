 ...
 * et `lightPhaseAt` classait les douze créneaux en « nuit » — y compris ceux de
 * l'après-midi.
 *
...
/**
 * Date civile LOCALE, au format `AAAA-MM-JJ`.
 *
 * Découper l'ISO à dix caractères donne la date UTC, pas la date locale. Pour
 * un minuit parisien — « 2026-09-02T22:00:00.000Z » — la découpe rend
 * « 2026-09-02 » alors que la journée affichée est le 3.
 *
 * Le décalage passait inaperçu tant que ces chaînes ne servaient que de clés
 * React et d'ancres jamais lues. Elles sont devenues des ADRESSES
 * PARTAGEABLES : `…/prevision#jour-2026-09-05` affichant « dimanche
 * 6 septembre » est une incohérence que la personne voit.
 */
export function localDateKey(date: Date, timeZone: string): string {
  // `fr-CA` produit nativement AAAA-MM-JJ, ce qui évite de recomposer les
  // morceaux à la main — et de se tromper de zéro initial.
