...
- **747 tests** (60 fichiers), dont 60 d'intégration
...
npx vitest run                            # 690 tests hermétiques
...
| Volume | 210 fichiers TS/TSX · ~26 600 lignes · 18 composants client · 747 tests · 154 URL au sitemap |
