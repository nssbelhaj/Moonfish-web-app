...
| `npm test` | 813 tests (Vitest). 744 hermétiques — aucun accès réseau ; les 35 d'intégration de la couche de données sont ignorés sans `DATABASE_URL`, et exécutés en intégration continue contre un vrai MySQL |
